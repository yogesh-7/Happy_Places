...
import com.happyplaces.utils.ImageUtils
import com.happyplaces.utils.ImageUtils.getBitmapFromUri
...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
        ...
        when (v!!.id) {
            R.id.et_date -> {
                DatePickerDialog(
                        ...
                        calendar.get(Calendar.YEAR), // Here the cal instance is created globally and used everywhere in the class where it is required.
            ...
            R.id.tv_select_current_location -> {
                ...
                if (!isLocationEnabled()) {
                    Toast.makeText(
                        this,
                        getString(R.string.your_location_is_off),
                        Toast.LENGTH_SHORT
                    ).show()
            ...
            R.id.btn_save -> {
                ...
                when {
                    ...
                    binding.etDescription.text.isNullOrEmpty() -> {
                        Toast.makeText(this, getString(R.string.please_enter_description), Toast.LENGTH_SHORT)
                                .show()
                    }
            ...
            if (requestCode == GALLERY) {
                if (data != null) {
                    ...
                    try {
                        ...
                        val selectedImageBitmap = getBitmapFromUri(this,contentURI!!)

                        saveImageToInternalStorage =
                            ImageUtils.saveImageToInternalStorage(this,selectedImageBitmap)
                        Log.e("Saved Image : ", "Path :: $saveImageToInternalStorage")

                        iv_place_image!!.setImageBitmap(selectedImageBitmap) // Set the selected image from GALLERY to imageView.
                    } catch (e: IOException) {
                        e.printStackTrace()
                        Toast.makeText(this@AddHappyPlaceActivity, getString(R.string.failed), Toast.LENGTH_SHORT)
                                .show()
                    }
                }
                ...
                saveImageToInternalStorage =
                    ImageUtils.saveImageToInternalStorage(this,thumbnail)
                Log.e("Saved Image : ", "Path :: $saveImageToInternalStorage")
    ...
    private fun updateDateInView() {
        ...
        binding.etDate.setText(sdf.format(calendar.time).toString()) // A selected date using format which we have used is set to the UI.
    }
    ...
    private fun showRationalDialogForPermissions() {
        AlertDialog.Builder(this)
                .setMessage(getString(R.string.show_rationalD_dalog_for_permissions_msg))
                .setPositiveButton(
